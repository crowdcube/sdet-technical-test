...
3. Open the repository and add the credentials for the account you've just created to [login.spec.ts](https://github.com/crowdcube/sdet-technical-test/blob/main/tests/login.spec.ts)
